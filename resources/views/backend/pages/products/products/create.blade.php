                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <form action="{{ route('admin.products.store') }}" method="POST" class="pb-650" id="product-form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-control select2 themeChange" name="theme_ids[]"
                                        ...
                                        @foreach ($themes as $theme)
                                            @if (in_array($theme->name, ['Halal Food', 'Halal Foods', 'Furniture', 'Organic']))
                                                @continue
                                            @endif
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="short_description"
                                        placeholder="{{ localize('Type your product short description') }}" rows="5"
                        ...
                        <div class="mb-4 card">
                            <div class="card-body">
                                <label for="name"
                                    class="form-label">{{ localize('Product Youtube Video Embedded Code') }}</label>
                        ...
                        <div class="card mb-4" id="section-3">
                            <div class="card-body">
                                <h5 class="mb-4">{{ localize('Product Categories') }} <span class="text-danger">*</span>
                                </h5>
                                <div class="mb-4">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label for="price" class="form-label">{{ localize('Price') }} <span
                                                        class="text-danger">*</span></label>
                                                <input type="number" min="0" step="0.0001" id="price" name="price"
                                                    placeholder="{{ localize('Product price') }}" class="form-control"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" id="stock" placeholder="{{ localize('Stock qty') }}"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label for="sku" class="form-label">{{ localize('SKU') }} <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" id="sku" placeholder="{{ localize('Product sku') }}"
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mb-3">
                                                <label for="code" class="form-label">{{ localize('Code') }} <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" id="code" placeholder="{{ localize('Product code') }}"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-0">
                                                    ...
                                                    <select class="select2 form-control" multiple="multiple"
                                                        ...
                                                        onchange="generateVariationCombinations()" name="option_1_choices[]">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-0">
                                                    ...
                                                    <select class="select2 form-control" multiple="multiple"
                                                        ...
                                                        onchange="generateVariationCombinations()" name="option_2_choices[]">
                                    ...
                                    @if (count($variations) > 0)
                                        ...
                                        <div class="chosen_variation_options">
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    <div class="mb-0">
                                                        <select class="form-select select2" onchange="getVariationValues(this)"
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-6">
                                        <div class="mb-0">
                                            ...
                                            <input type="number" id="min_purchase_qty" name="min_purchase_qty" min="1"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-0">
                                            ...
                                            <input type="number" id="max_purchase_qty" name="max_purchase_qty" min="1"
                                    ...
                                    <div class="col-lg-6 d-none">
                                        <div class="mb-0">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append"><span class="input-group-text">hr(s)</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-0">
                                                ...
                                                <input type="number" lang="en" min="0" value="0" step="0.01"
                                                    placeholder="{{ localize('Tax') }}" name="taxes[]" class="form-control"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
