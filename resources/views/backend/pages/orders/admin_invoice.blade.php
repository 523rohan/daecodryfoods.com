...
<head>
    ...
    <title>{{ localize('New Order Received') }}</title>
    <style type="text/css">
        /* RESET STYLES */
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="header">
                ...
                @endif
                <h2 class="header-title">{{ localize('New Order Received!') }}</h2>
                ...
                <div style="margin-top: 15px;">
                    <a href="{{ route('admin.orders.show', $order->id) }}" style="display: inline-block; padding: 10px 20px; background-color: #10B981; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 700; font-size: 14px;">{{ localize('View Order Details') }}</a>
                </div>
            </div>
            ...
            <div class="content">
                <!-- CUSTOMER INFO -->
                <div class="section-title">{{ localize('Customer Details') }}</div>
                <div class="info-card" style="margin-bottom: 20px;">
                    <span class="info-name">{{ optional($order->user)->name }}</span>
                    <div class="info-text">
                        {{ localize('Email') }}: {{ optional($order->user)->email ?: localize('N/A') }}<br>
                        {{ localize('Phone') }}: {{ optional($order->user)->phone ?: localize('N/A') }}
                    </div>
                </div>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td class="info-col" width="50%" style="padding-left: 15px;">
                            <div class="section-title">{{ localize('Payment & Delivery') }}</div>
                            <div class="info-card">
                                <div class="info-text">
            ...
            <!-- FOOTER -->
            <div class="footer">
                <p class="footer-text"><strong>{{ localize('Administrative Notification') }}</strong></p>
                <div style="margin-top: 20px; border-top: 1px solid #E2E8F0; padding-top: 20px;">
                    <p class="footer-text">{{ getSetting('system_title') }} &bull; {{ localize('Administrative Panel') }}</p>
