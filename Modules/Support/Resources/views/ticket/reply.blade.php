                          ...
                          <div class="d-flex align-items-start">
                            ...
                            <div class="ms-3 w-100">
                              ...
                              @foreach ($reply->replyImages as $image)
                                <a href="{{ staticAsset($image->file_path) }}" class="d-block mt-3" download="{{ basename($image->file_path) }}">
                            ...
                            <div class="d-flex align-items-start">
                              ...
                              <div class="ms-3 w-100">
                                ...
                                @foreach ($ticket->images as $item)
                                  <a href="{{ staticAsset($item->file_path) }}" class="d-block mt-3" download="{{ basename($item->file_path) }}">
                                    <i data-feather="paperclip" class="icon-14 me-2"></i>{{ localize('download') }}</a>
                                @endforeach
